...
Частенько бывают случаи когда появляется какой-нибудь проект и возникает необходимость быстро собрать рабочую модель сайта с минимальным функционалом. Учитывая практический опыт мне удалось подготовить интересную структуру шаблона модели сайта. 
